...
#include <string>
//#include <string.h>
#include "OpenCV.framework/Headers/opencv/cv.h"
#include "OpenCV.framework/Headers/opencv/cvaux.h"
#include "OpenCV.framework/Headers/opencv/highgui.h"
